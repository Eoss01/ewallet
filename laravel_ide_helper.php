...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
        ...
        /**
         * @see \Imanghafoori\MasterPass\MasterPassServiceProvider::defineIsUsingMasterPass()
         * @static
         */
        public static function isLoggedInByMasterPass()
        {
            return \Illuminate\Auth\SessionGuard::isLoggedInByMasterPass();
        }
...
namespace Illuminate\Auth {
    ...
    class RequestGuard {
        ...
        public static function isLoggedInByMasterPass()
        {
            return \Illuminate\Auth\RequestGuard::isLoggedInByMasterPass();
        }
